...
**"opensea-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing OpenSea's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** OpenSea changing its markup is expected —
